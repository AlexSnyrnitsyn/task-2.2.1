...
public class UserDaoImp implements UserDao {
   ...
   public User getUserByModelAndSeries(String model, int series) {
      ...
      List<User> userList = listUsers().stream().
              filter(user -> user.getUserCar() == carList.get(0)).collect(Collectors.toList());
      System.out.println(userList.get(0).getFirstName() + " Владелец машины");
